                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            ...
                            <input type="text" name="address_1" class="form-control" id="address_1" autocomplete="off"
                                   placeholder="Enter Address" value="{{$item ? $item->address_1 : old('address_1')}}" required/>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="form-group row">
                        <div class="col-4">
                            ...
                            <input type="text" name="buyer_code" class="form-control" id="buyer_code" autocomplete="off"
                                   placeholder="Enter buyer code" value="{{$item ? $item->buyer_code : old('buyer_code')}}"/>
                        </div>
                        <div class="col-4">
                            <label>Bank:</label>
                        ...
                        <div class="col-4">
                            ...
                            <select name="bank_country_id" class="form-control">
                                <option value="">Select country</option>
                                @foreach($countries as $country)
                                    <option value="{{$country->id}}" {{ ($item?->bank_country_id == $country->id) ? 'selected' : '' }}>{{$country->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-4">
                            ...
                            <select name="bank_state_id" class="form-control">
                                ...
                                @foreach($states as $state)
                                    <option value="{{$state->id}}" {{ ($item?->bank_state_id == $state->id) ? 'selected' : '' }}>{{$state->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-4">
                            ...
                            <input type="text" name="state_code" class="form-control" id="buyer_code" autocomplete="off"
                                   placeholder="Enter State code" value="{{$item ? $item->state_code : old('state_code')}}"/>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            ...
                            <select name="bank_city_id" class="form-control">
                                ...
                                @foreach($cities as $city)
                                    <option value="{{$city->id}}" {{ ($item?->bank_city_id == $city->id) ? 'selected' : '' }}>{{$city->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-4">
                            ...
                            <select name="gst_type" class="form-control" required>
                                ...
                                <option value="registered_b2b" {{ ($item?->gst_type == 'registered_b2b') ? 'selected' : '' }}>Registered B2B</option>
                                <option value="unregistered_b2b" {{ ($item?->gst_type == 'unregistered_b2b') ? 'selected' : '' }}>UnRegistered B2B</option>
                                <option value="export" {{ ($item?->gst_type == 'export') ? 'selected' : '' }}>Export</option>
                                <option value="ecommerce" {{ ($item?->gst_type == 'ecommerce') ? 'selected' : '' }}>ECommerce</option>
                                <option value="sez" {{ ($item?->gst_type == 'sez') ? 'selected' : '' }}>SEZ</option>
                                <option value="deemed_export" {{ ($item?->gst_type == 'deemed_export') ? 'selected' : '' }}>Deemed Export</option>
                                <option value="composite" {{ ($item?->gst_type == 'composite') ? 'selected' : '' }}>Composite</option>
                            </select>
                        </div>
                        <div class="col-4">
                            <div class="checkbox-list mt-5">
                        ...
                        <div class="col-4">
                            ...
                            <select name="account_group" class="form-control">
                                ...
                                <option value="land" {{ ($item?->account_group == 'land') ? 'selected' : '' }}>Land</option>
                                <option value="building" {{ ($item?->account_group == 'building') ? 'selected' : '' }}>Building</option>
                                <option value="plant_machinery" {{ ($item?->account_group == 'plant_machinery') ? 'selected' : '' }}>Plant & Machinery</option>
                                <option value="equipments" {{ ($item?->account_group == 'equipments') ? 'selected' : '' }}>Equipments</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-4">
                            ...
                            <select name="vendor_group_id" class="form-control">
                                ...
                                @foreach($vendor_groups as $vendor_group)
                                    <option value="{{$vendor_group->id}}" {{ ($item?->vendor_group_id == $vendor_group->id) ? 'selected' : '' }}>{{$vendor_group->group}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="col-4">
                            ...
                            <select name="port_landing" class="form-control">
                                ...
                                @foreach($ports as $port)
                                    <option value="{{$port->id}}" {{ ($item?->port_landing == $port->id) ? 'selected' : '' }}>{{$port->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-4">
                            ...
                            <select name="port_destination" class="form-control">
                                ...
                                <option value="bangalore" {{ ($item?->port_destination == 'bangalore') ? 'selected' : '' }}>Bangalore</option>
                                <option value="haryana" {{ ($item?->port_destination == 'haryana') ? 'selected' : '' }}>Haryana</option>
                                <option value="krishnagiri" {{ ($item?->port_destination == 'krishnagiri') ? 'selected' : '' }}>Krishnagiri</option>
                                <option value="katunayake" {{ ($item?->port_destination == 'katunayake') ? 'selected' : '' }}>Katunayake</option>
                                <option value="uttar_pardesh" {{ ($item?->port_destination == 'uttar_pardesh') ? 'selected' : '' }}>Uttar Pardesh</option>
                                <option value="tiruppur" {{ ($item?->port_destination == 'tiruppur') ? 'selected' : '' }}>Tiruppur</option>
                            </select>
                        </div>
                        <div class="col-4">
                            ...
                            <select name="currency" class="form-control">
                                ...
                                <option value="rupess" {{ ($item?->currency == 'rupess') ? 'selected' : '' }}>RUPEES</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
