...
@section('content')
    @php
        $route_main = 'payment_term';
        $permission_name = 'payment_terms';
        $permission_name = 'payment_terms';
    @endphp
        ...
        <div class="card-body">
            <table class="table table-bordered table-hover" id="table_invoice_settings">
                ...
                <tr class="text-uppercase">
                    ...
                    <th class="pl-7"><span class="text-dark-75">Payment terms for</span></th>
                ...
                @if (!empty($list))
                    @foreach ($list as $key => $item)
                        <tr>
                            ...
                            <td>
                                <span class="label label-lg font-weight-bold label-inline label-light-{{ $item->status ?  'success': 'danger' }} ">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-0">
                    <div class="form-group row">
                        <div class="col-12">
                            <label class="mb-0">Name<b class="text-danger">*</b></label>
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            <label class="mb-0">Description<b class="text-danger">*</b></label>
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            <label class="mb-0">Payment Terms For<b class="text-danger">*</b></label>
                            <select name="payment_terms_for" id="payment_terms_for" class=" form-control" required>
                                <option value="0">Select Type</option>
                                @foreach($payment_types as $line)
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            <label class="mb-0">Number Of Days<b class="text-danger">*</b></label>
                            <input type="number" name="days" id="days" class="form-control" autocomplete="off"
                                   placeholder="0" value="{{ old('days') }}" required/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-12">
                            <label class="mb-0">Interest Percentage<b class="text-danger">*</b></label>
                            <input type="number" step="0.01" name="interest" id="interest" class="form-control"
                                   autocomplete="off"
                                   placeholder="0" value="{{ old('interest') }}" required/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-12">
                            <label class="mb-0">Advance Percentage</label>
                            <input type="number" step="0.01" name="advance" id="advance" class="form-control"
                                   autocomplete="off"
                                   placeholder="0" value="{{ old('advance') }}"/>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="deleteCurrentModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Delete Payment Term</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete this payment term?</p>
                </div>
        ...
        $(document).ready(function () {
            ...
            $('.btn-edit').on('click', function () {
                ...
                $.get('/{{$route_main}}/' + id + '/edit', function (data) {
                    ...
                    $('#payment_terms_for').val(data.payment_terms_for);
                    $('#days').val(data.days);
