...
@section('content')
    @php
        $route_main = 'fabric_opening_balance';
        $module_label = 'Fabric Opening Balance';
        $permission_name = 'fabric_opening_balance';
    @endphp
        ...
        <div class="card-body">
            <table class="table table-bordered table-hover" id="table_invoice_settings">
                ...
                <tr class="text-uppercase">
                    ...
                    <th class="pl-7"><span class="text-dark-75">INWARD NUMBER</span></th>
