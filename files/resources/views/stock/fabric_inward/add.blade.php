                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-4">
                            ...
                            <select name="vendor_group_id" class="form-control" onchange="change_vendor_group(this)" required>
                        ...
                        <div class="col-4">
                            ...
                            <select name="po_id" id="po_id" class="form-control" required>
                                ...
                                @if(!empty($item->po))
                                    <option value="{{ $item->po_id ?? '' }}" selected>{{ $item->po?->po_number ?? '' }}</option>
                                @endif
                            </select>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="col-12">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr class="table-primary">
                                    ...
                                    <th>Picks</th>
                                    <th>Job Rate</th>
                                    <th>Grade<b class="text-danger">*</b></th>
                                    <th>Remarks</th>
                                    <th>Is Cutpiece</th>
                                    <th>
                                ...
                                @if(!empty($item?->details))
                                    @foreach($item?->details as $index => $row)
                                        <tr>
                                            ...
                                            <td>
                                                <select name="details[{{$index}}][grade_id]" class="form-control" required>
                                                    <option value="">Select</option>
        ...
        @push('scripts')
            ...
            <script>
                ...
                const addRow = () => {
                    ...
                    tr += `</td>`;
                    tr += `<td>`;
                    tr += `    <select name="details[${index}][grade_id]" class="form-control" required>`;
                    tr += `        <option value="">Select</option>`;
