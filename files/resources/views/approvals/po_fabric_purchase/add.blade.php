@extends('main')
@section('content')
    {{ html()->form('POST', 'po_fabric_purchase_create')->open() }}
            ...
            <div class="card card-custom " id="kt_page_sticky_card">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('approval_po_fabric_purchase') }}" class="btn btn-light-primary font-weight-bolder mr-2">
                ...
                <div class="card-body">
                    <div>
                        <h1 class="text-center">Fabric Purchase Order</h1>
                        {{-- First table --}}
                        <table class="table">
                            {{-- Line 1 --}}
                            <tr>
                        ...
                        <div class="row border border-2 border-light-dark p-4">
                            ...
                            <div class="col-3">
                                <table>
                                    <tr>
                                        <td><b>Customer SO</b></td>
                                        <td>:</td>
                                        <td>{{$item->customer_so ?? ''}}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Fabric Type</b></td>
                                        <td>:</td>
                                        <td>{{$item->fabric_type?->name ?? ''}}</td>
                                    </tr>
                                    <tr>
                                        <td><b>GST Type</b></td>
                                        <td>:</td>
                        ...
                        @foreach($item->details as $index => $row)
                            <div class="row border border-2 border-light-dark p-4">
                                <div class="col-4 border-right border-4 border-light-dark">
                                    <table>
                                        <tr>
                                            <td><b>Sort Number</b></td>
                                            <td>:</td>
                                            <td>{{$row->quality?->sort_no}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>Quality</b></td>
                                            <td>:</td>
                                            <td>{{$row->quality?->details}}</td>
                                        </tr>
                                        <tr>
                                            <td><b>Quantity</b></td>
                                            <td>:</td>
                                ...
                                <div class="col-4 border-right border-4 border-light-dark">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                @foreach($row->yarn_certification_types as $index => $line)
                                                {{$line->yarn_certification_type?->name}}<br>
                                                @endforeach
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>{{$row->unit_price}} {{$row->currency?->name ?? 'Rs'}}</td>
                                        </tr>
                                        <tr>
                    ...
                    @if(empty($item->approval))
                        <div class="card-footer text-center">
                            ...
                            <a href="{{ route('approval_po_fabric_purchase') }}" class="btn btn-warning font-weight-bolder w-135px">
                                CANCEL
                            </a>
                        </div>
                    @endif
