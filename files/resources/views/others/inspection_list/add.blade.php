...
@section('content')
    ...
    @if($jobwork?->id > 0)
        @method('PUT')
    @endif
    <input type="hidden" name="jobwork_fabric_receive_id" value="{{$jobwork?->id ?? ''}}">
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-custom ">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <label>EPI</label>
                            <input type="text" name="epi" class="form-control"
                                   value="{{$item ? $item?->epi : '' }}"/>
                        </div>
                    </div>
                    {{-- Line 2 --}}
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" name="weft_count" class="form-control"
                                   value="{{$item ? $item?->weft_count : '' }}"/>
                        </div>
                        <div class="col-3">
                            <label>Warp Count</label>
                            <input type="text" name="warp_count" class="form-control"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" class="form-control" readonly
                                   value="{{$jobwork?->jobwork_fabric_receive?->is_last_piece ?? 0 == '1' ? 'Yes' : 'No' }}"/>
                        </div>
                    </div>
                    {{-- Line 4 --}}
                    <div class="form-group row">
