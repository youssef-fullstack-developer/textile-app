...
@section('content')
    @php
        $route_main = 'countries';
        $module_label = 'Country';
        $permission_name = 'country';
    @endphp
    <div class="card card-custom" style="box-shadow: none">
        <div class="card-header flex-wrap border-0 pt-0 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <button data-toggle="modal" data-target="#storeCurrentModel" class="btn btn-primary font-weight-bolder mr-2">
                    ...
                    @if (!empty($countries))
                        @foreach ($countries as $key => $country)
                            <tr>
                                ...
                                <td>{{ $country->code }}</td>
                                <td>
                                <span class="label label-lg font-weight-bold label-inline label-light-{{ $country->status ?  'success': 'danger' }} ">
                                {{ $country->status ?  'Active': 'Inactive' }}</span>
                                </td>
                                <td class="d-flex">
                                ...
                                @can($permission_name.'-delete')
                                    <a href="javascript:void(0)" data-id="{{ $country->id }}" title="Delete"
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            ...
                            <input type="text" name="name" class="form-control" id="name" autocomplete="off"
                                placeholder="Enter Country Name" value="" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            ...
                            <input type="text" name="code" class="form-control" id="code" autocomplete="off"
                                placeholder="Enter Country Code" value="" required />
                        </div>
                    </div>
