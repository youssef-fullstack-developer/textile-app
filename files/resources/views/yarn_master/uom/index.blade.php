                    ...
                    @if (!empty($uom))
                        @foreach ($uom as $key => $u)
                            <tr>
                                ...
                                <td>{{ $u->description }}</td>
                                <td>
                                    <span class="label label-lg font-weight-bold label-inline label-light-{{ $u->status ?  'success': 'danger' }} ">
                                {{ $u->status ?  'Active': 'Inactive' }}</span>
                                </td>
                                <td class="d-flex">
                                ...
                                @can($permission_name.'-delete')
                                    <a href="javascript:void(0)" data-id="{{ $u->id }}" title="Delete"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            ...
                            <input type="text" name="to_meter" class="form-control" id="to_meter" autocomplete="off"
                                placeholder="Enter Meter Conversion Value" value="" required />
                        </div>
                    </div>
