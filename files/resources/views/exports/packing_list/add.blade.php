                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group row">
                                <div class="col-4">
                                    ...
                                    <select name="invoice_number" class="form-control" required>
                                        <option value="">Select Company Name</option>
                                        @foreach($exporters as $row)
                                            <option
                                                value="{{$row->id}}">{{$row->name}}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group row">
                                <div class="col-4">
                                    <label>Port of discharge <b class="text-danger">*</b></label>
                                    <textarea name="port_of_discharge" class="form-control" rows="1"></textarea>
                                </div>
                                <div class="col-4">
                                                ...
                                                <tr>
                                                    <td>
                                                        <select
                                                            ...
                                                            @foreach ($banks as $one)
                                                                <option value="{{ $one->id }}"
                                                                    {{ ($row?->sales_order_id == $one->id) ? 'selected' : '' }}
                                                                >{{ $one->name  }}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select
                                                            ...
                                                            @foreach ($banks as $one)
                                                                <option value="{{ $one->id }}"
                                                                    {{ ($row?->polds_date_id == $one->id) ? 'selected' : '' }}
                                                                >{{ $one->name  }}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
...
@push('scripts')
    <script>
        ...
        const addRowOther = () => {
            ...
            html += `    <td>`;
            html += `        <select`;
            html += `            name="others[${index}][cone_tip_color_id]"`;
            html += `            class="form-control">`;
            html += `            <option value="">Select</option>`;
            @foreach ($banks as $one)
