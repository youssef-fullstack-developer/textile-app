                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            ...
                            <select name="jobwork_id" class="form-control" required>
                                <option value="">Select</option>
                        ...
                        <div class="col-3">
                            ...
                            <input type="number" name="pick_rate" class="form-control"
                                   value="{{ $item ? $item?->pick_rate : '' }}"/>
                        </div>
                        <div class="col-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            ...
                            <select name="chk_name_id" class="form-control">
                                <option value="">Select</option>
                                @foreach ($chks as $one)
                                    <option
                    ...
                    <div class="form-group row">
                        <div class="col-3">
                            <label>Picks</label>
                            <input type="number" name="picks" class="form-control"
        ...
        @push('scripts')
            ...
            <script>
                ...
                const jobwork_change = (elm) => {
                    ...
                    {{--            $('#vendor_group').val(item?.vendor?.name);--}}
                    {{--            $('#gate_pass_no').val();--}}
                    {{--        }--}}
                    {{--    },--}}
                    {{--    error: function (data) {--}}
