...
@section('content')
    @php
        $route_main = 'godown';
        $module_label = 'Godown Location';
        $permission_name = 'godown_location';
    @endphp
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-2 row">
                        <div class="col-12 ">
                            ...
                            <select name="location" id="location" class="form-control" required>
                                ...
                                <option value="Yarn Godown">Yarn Godown</option>
                                <option value="Fabric Receive Godown">Fabric Receive Godown</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group mb-2 row">
                    ...
                    <div class="form-group mb-2 row">
                        <div class="col-12 ">
                            ...
                            <select name="type" id="type" class="form-control">
                                <option value="">Select</option>
                                @foreach($location_types as $line)
                    ...
                    <div class="form-group mb-2 row">
                        <div class="col-12 ">
                            <label>Zone</label>
                            <input type="text" name="zone" id="zone" class="form-control" placeholder="Enter Code"/>
                        </div>
                    </div>
                            ...
                            <div class="col-form-label">
                                <div class="radio-inline">
                                    <label class="radio radio-success">
                                        <input type="radio" name="is_default" id="is_default_true" checked="checked"
                                               value="1"/>
                                        <span></span>
                                        Yes
                                    </label>
                                    <label class="radio radio-danger">
                                        <input type="radio" name="is_default" id="is_default_false" value="0"/>
                                        <span></span>
                                        No
                                    </label>
                                </div>
        ...
        $(document).ready(function () {
            ...
            $('.btn-edit').on('click', function () {
                ...
                $.get('/{{$route_main}}/' + id + '/edit', function (data) {
                    ...
                    $('#type').val(data.type);
                    $('#zone').val(data.zone);
                    if (data.is_default === true || data.is_default === 1 || data.is_default == '1') {
                        $('#is_default_true').prop("checked", true);
                        $('#is_default_false').prop("checked", false);
                    } else {
                        $('#is_default_true').prop("checked", false);
                        $('#is_default_false').prop("checked", true);
                    }
