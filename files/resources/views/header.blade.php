                                ...
                                <ul class="menu-content">
                                    <li class="menu-item">
                                        <ul class="menu-inner">
                                            ...
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('consignee.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                        class="menu-text">Consignee</span></a>
                                            </li>
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('shades.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                    ...
                                    <li class="menu-item">
                                        <ul class="menu-inner">
                                            ...
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('agents.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                            ...
                            <div class="menu-subnav">
                                <ul class="menu-content">
                                    <li class="menu-item">
                                        <ul class="menu-inner">
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{ route('buyers.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                        class="menu-text">Buyer</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{ route('sales_order.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                        class="menu-text">Sales Order</span>
                                                </a>
                                            </li>
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{route('packing_list.index')}}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                    ...
                    <li class="menu-item  menu-item-submenu menu-item-rel" data-menu-toggle="hover"
                        ...
                        <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                            <ul class="menu-subnav">
                                ...
                                {{--                                </li>--}}
                                <li class="menu-item " aria-haspopup="true">
                                    <a href="{{route('po_fabric_processing_jw.index')}}" class="menu-link bg-warningggg">
                                        <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                            ...
                            <div class="menu-subnav">
                                <ul class="menu-content">
                                    <li class="menu-item">
                                        <ul class="menu-inner">
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="{{ route('yarn_po.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                    ...
                                    <li class="menu-item">
                                        <ul class="menu-inner">
                                            ...
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('hairiness.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                        class="menu-text">Hairiness</span>
                                                </a>
                                            </li>
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('count_cv.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                        class="menu-text">Count CV</span>
                                                </a>
                                            </li>
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('strength_cv.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                    ...
                    <li class="menu-item  menu-item-submenu menu-item-rel" data-menu-toggle="hover"
                        ...
                        <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                            <ul class="menu-subnav">
                                ...
                                {{--                                <li class="menu-item" aria-haspopup="true">--}}
                                {{--                                    <a href="{{ route('inspection.index') }}" class="menu-link  bg-warningggg">--}}
                                {{--                                        <i class="menu-bullet menu-bullet-dot"><span></span></i><span--}}
                                {{--                                            class="menu-text">Inspection Edit New</span>--}}
                                {{--                                    </a>--}}
                                {{--                                </li>--}}

                                {{--                                <li class="menu-item" aria-haspopup="true">--}}
                                {{--                                    <a href="{{ route('sortrackmapping.index') }}" class="menu-link  bg-warningggg">--}}
                                {{--                                        <i class="menu-bullet menu-bullet-dot"><span></span></i><span--}}
                                {{--                                            class="menu-text">Sort And Rack Mapping</span>--}}
                                {{--                                    </a>--}}
                                {{--                                </li>--}}
                            </ul>
                        </div>
                            ...
                            <div class="menu-subnav">
                                <ul class="menu-content">
                                    <li class="menu-item">
                                        <ul class="menu-inner">
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('planning.orders') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                            ...
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('sizing_plan.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                    ...
                                    <li class="menu-item">
                                        <ul class="menu-inner">
                                            ...
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('beam_inward.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                            ...
                                            {{--                                            <li class="menu-item " aria-haspopup="true">--}}
                                            {{--                                                <a href="{{ route('planning.yarn_processing_contract.index') }}"--}}
                                            {{--                                                   class="menu-link ">--}}
                                            {{--                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span--}}
                                            ...
                                            {{--                                            <li class="menu-item " aria-haspopup="true">--}}
                                            {{--                                                <a href="{{ route('planning.yarn_processing_contract_issue.index') }}"--}}
                                            {{--                                                   class="menu-link ">--}}
                                            {{--                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span--}}
                                            ...
                                            {{--                                            <li class="menu-item " aria-haspopup="true">--}}
                                            {{--                                                <a href="{{ route('planning.yarn_processing_receive.index') }}"--}}
                                            {{--                                                   class="menu-link ">--}}
                                            {{--                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span--}}
                                            ...
                                            {{--                                            </li>--}}
                                            {{--                                            <li class="menu-item " aria-haspopup="true">--}}
                                            {{--                                                <a href="{{ route('planning.yarn_processing_return.index') }}"--}}
                                            {{--                                                   class="menu-link ">--}}
                                            {{--                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span--}}
                                ...
                                <ul class="menu-content">
                                    <li class="menu-item">
                                        <ul class="menu-inner">
                                            ...
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('countries.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                                        class="menu-text">Country</span>
                                                </a>
                                            </li>
                                            ...
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('cities.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
                                            ...
                                            <li class="menu-item " aria-haspopup="true">
                                                <a href="{{ route('states.index') }}" class="menu-link bg-warningggg">
                                                    <i class="menu-bullet menu-bullet-dot"><span></span></i><span
