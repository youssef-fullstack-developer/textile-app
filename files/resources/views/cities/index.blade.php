                    ...
                    @if (!empty($cities))
                        @foreach ($cities as $key => $city)
                            <tr>
                                ...
                                <td>{{ $city->name }}</td>
                                <td>
                                <span class="label label-lg font-weight-bold label-inline label-light-{{ $city->status ?  'success': 'danger' }} ">
                                {{ $city->status ?  'Active': 'Inactive' }}</span>
                                </td>
                                <td class="d-flex">
                                ...
                                @can($permission_name.'-delete')
                                    <a href="javascript:void(0)" data-id="{{ $city->id }}" title="Delete"
