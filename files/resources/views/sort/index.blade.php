...
@section('content')
    @php
        $route_main = 'sort';
        $module_label = 'Sort Master';
        $permission_name = 'sort_master';
    @endphp
                    ...
                    @if (!empty($sorts))
                        @foreach ($sorts as $key => $sort)
                            <tr>
                                ...
                                <td>{{ $sort->sort_no }}</td>
                                <td>{{ $sort->details }}</td>
                                <td>{{ $sort->get_master_quality?->details }}</td>
                                <td>{{ $sort->numeric }}</td>
                                ...
                                @can($permission_name.'-delete')
                                    <a href="javascript:void(0)" data-id="{{ $sort->id }}" title="Delete"
