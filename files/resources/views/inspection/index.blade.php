...
@section('content')
    @php
        $route_main = 'inspection';
        $module_label = 'Inspection Type';
        $permission_name = 'inspection_type';
    @endphp
            ...
            <table class="table table-bordered table-hover" id="table_invoice_settings">
                ...
                <tbody>
                    @if (!empty($inspections))
                        @foreach ($inspections as $key => $item)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>{{ $item->name }}</td>
                                <td>
    ...
    <div class="modal fade" id="storeCurrentModel" tabindex="-1" role="dialog" aria-labelledby="storeCurrentModelLabel"
        aria-hidden="true">
