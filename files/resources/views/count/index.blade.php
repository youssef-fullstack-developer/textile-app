                ...
                @if (!empty($count))
                    @foreach ($count as $key => $c)
                        <tr>
                            ...
                            <td>
                                <span
                                    class="label label-lg font-weight-bold label-inline label-light-{{ $c->status ?  'success': 'danger' }} ">
                                {{ $c->status ?  'Active': 'Inactive' }}</span>
                            </td>
                            <td class="d-flex">
                                ...
                                <a href="javascript:void(0)" data-id="{{ $c->id }}" title="Delete"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <div class="col-12">
                            <label>Count:</label>
                            <input type="number" name="count" class="form-control" id="count" autocomplete="off"
