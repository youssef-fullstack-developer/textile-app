...
@section('content')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Weave</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12">
                        ...
                        <input type="number" name="no_of_heald_frame" id="no_of_heald_frame" class="form-control"
                                value="" />
                    </div>
                    </div>
    ...
    <div class="modal fade" id="deleteCurrentModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Delete Weave</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete this Weave?</p>
                </div>
        ...
        $(document).ready(function () {
            ...
            $('.btn-edit').on('click', function () {
                ...
                $.get('/{{$route_main}}/' + id + '/edit', function (data) {
                    ...
                    $('#_method').val('PUT');
                    $('#name').val(data.name);
                    $('#no_of_heald_frame').val(data.no_of_heald_frame);
