                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            ...
                            <input type="number" name="manual_po_number" class="form-control" autocomplete="off"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            ...
                            <select name="yarn_type_id" class="form-control">
                                <option value="">Select</option>
                                @foreach($yarn_types as $row)
                                    <option
                                        value="{{$row->id}}" {{ ($item?->yarn_type_id == $row->id) ? 'selected' : '' }}>{{$row->type}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            ...
                            <select name="purchase_type_id" class="form-control" required>
                                <option value="">Select</option>
                            ...
                            <div class="form-group border p-3 border-dark border-2 tr">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="number" name="order_details[{{$i}}][cones_per_bag]"
                                ...
                                <div class="form-group row">
                                    <div class="col-4">
                                        ...
                                        <input type="number" name="order_details[{{$i}}][kg_per_bag]" required
                                               class="form-control" autocomplete="off"
                                               value="{{$detail ? $detail?->kg_per_bag : old('kg_per_bag') }}"/>
                                    </div>
                                    <div class="col-4">
                                        <label>Cone Weight</label>
                                        <input type="number" name="order_details[{{$i}}][cone_weight]"
                                               class="form-control" autocomplete="off"
                                ...
                                <div class="form-group row">
                                    <div class="col-4">
                                        ...
                                        <input type="number" name="order_details[{{$i}}][no_of_bags]"
                                               class="form-control"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group row">
                                            <div class="col-8">
                                                ...
                                                <input type="number" name="order_details[{{$i}}][quantity]" required
                                                       class="form-control"
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="number" name="order_details[{{$i}}][mill_price]" required
                                               class="form-control" autocomplete="off"
                                               id="mill_price_{{$i}}"
                                ...
                                <div class="form-group row">
                                    <div class="col-4">
                                        ...
                                        <input type="number" name="order_details[{{$i}}][basic_amount]"
                                               class="form-control"
                                    ...
                                    <div class="col-4 igst_container">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-6"><label>IGST Amount</label>
                                ...
                                <div class="form-group row">
                                    <div class="col-4">
                                        ...
                                        <input type="number" name="order_details[{{$i}}][total_amount]"
                                               class="form-control" autocomplete="off"
                                               value="{{$detail ? $detail?->total_amount : old('total_amount') }}"/>
                                    </div>
                                    <div class="col-4">
                                        <label>Provisional Freight</label>
                                        <input type="number" name="order_details[{{$i}}][provisional_freight]"
                                               class="form-control" autocomplete="off"
                                ...
                                <div class="form-group row">
                                    <div class="col-4">
                                        ...
                                        <input type="number" name="order_details[{{$i}}][mill_gst_price]"
                                               class="form-control" autocomplete="off"
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="number" name="order_details[{{$i}}][final_price]"
                                               class="form-control" autocomplete="off"
                                               id="final_price_{{$i}}"
...
@push('scripts')
    <script>
        const add_detail_row = () => {
            ...
            html += `                <input type="number" name="order_details[${index}][cones_per_bag]"`;
            ...
            html += `                <input type="number" name="order_details[${index}][kg_per_bag]" required`;
            html += `                       class="form-control" autocomplete="off"/>`;
            html += `            </div>`;
            html += `            <div class="col-4">`;
            html += `                <label>Cone Weight</label>`;
            html += `                <input type="number" name="order_details[${index}][cone_weight]"`;
            html += `                       class="form-control" autocomplete="off"/>`;
            html += `            </div>`;
            html += `            <div class="col-4">`;
            ...
            html += `                <input type="number" name="order_details[${index}][no_of_bags]"`;
            html += `                       class="form-control"/>`;
            html += `            </div>`;
            html += `            <div class="form-group row">`;
            html += `                <div class="col-8">`;
            html += `                    <label>Quantity<b class="text-danger">*</b></label>`;
            html += `                    <input type="number" name="order_details[${index}][quantity]" required`;
            html += `                           class="form-control"`;
            ...
            html += `                <input type="number" name="order_details[${index}][mill_price]" required`;
            ...
            html += `                <input type="number" name="order_details[${index}][basic_amount]"`;
            ...
            html += `            <input type="number" class="form-control" readonly`;
            ...
            html += `                <input type="number" name="order_details[${index}][total_amount]"`;
            html += `                       class="form-control" autocomplete="off"/>`;
            html += `            </div>`;
            html += `            <div class="col-4">`;
            html += `                <label>Provisional Freight</label>`;
            html += `                <input type="number" name="order_details[${index}][provisional_freight]"`;
            ...
            html += `                <input type="number" name="order_details[${index}][mill_gst_price]"`;
            html += `                id="mill_gst_price_${index}" onchange="change_final_price(${index})"`;
            html += `                       class="form-control" autocomplete="off"/>`;
            html += `            </div>`;
            html += `            <div class="col-4">`;
            html += `                <label>Final Price</label>`;
            html += `                <input type="number" name="order_details[${index}][final_price]"`;
