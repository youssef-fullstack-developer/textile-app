                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            ...
                            <input type="number" step="0.01" name="production_mtrs" class="form-control" autocomplete="off"
                            ...
                            @if(!empty($item->orders))
                                @foreach($item?->orders as $index => $one)
                                    <tr>
                                        ...
                                        <td>{{$one->order?->order_no}}</td>
                                        <td></td>
                                        <td></td>
                                        <td>
                                            <input type="number" step="0.01" name="orders_selected[{{$index}}][planned_quantity]"
                                                   class="form-control"
                    ...
                    <div class="col-12">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td><b>80</b></td>
                                <td><input type="number" step="0.01" name="piece_length_80" class="form-control" autocomplete="off"
                                           value="{{ $item ? $item?->piece_length_80 : old('piece_length_80') }}"/></td>
                            </tr>
                            <tr>
                                <td><b>20</b></td>
                                <td><input type="number" step="0.01" name="piece_length_20" class="form-control" autocomplete="off"
                    ...
                    <table class="table border border-dark border-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" step="0.01" name="quality_reed" id="quality_reed" class="form-control"
                                       autocomplete="off"
                                       value="{{ $item ? $item?->quality_reed : old('quality_reed') }}"/>
                            </td>
                            <td>Quality Picks</td>
                            <td>
                                <input type="number" step="0.01" name="quality_picks" id="quality_picks" class="form-control"
                                       autocomplete="off"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" step="0.01" name="l_to_l" id="l_to_l" class="form-control" autocomplete="off"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" step="0.01" name="dents" id="dents" class="form-control" autocomplete="off"
                                       required value="{{ $item ? $item?->dents : old('dents') }}"/>
                            </td>
                            <td>Ends per Dent<b class="text-danger">*</b></td>
                            <td>
                                <input type="number" step="0.01" name="ends_per_dent" id="ends_per_dent" class="form-control"
                                       autocomplete="off"
                                       required value="{{ $item ? $item?->ends_per_dent : old('ends_per_dent') }}"/>
                            </td>
                            <td>Selvedge Ends<b class="text-danger">*</b></td>
                            <td>
                                <input type="number" step="0.01" name="selvedge_ends" id="selvedge_ends" class="form-control"
                                       autocomplete="off"
                        ...
                        <tr>
                            <td>Width</td>
                            <td>
                                <input type="number" step="0.01" name="width" id="width" class="form-control" autocomplete="off"
                                       value="{{ $item ? $item?->width : old('width') }}"/>
                            </td>
                            <td>Catch Cord Ends</td>
                            <td>
                                <input type="number" step="0.01" name="catch_cord_ends" id="catch_cord_ends" class="form-control"
                                       autocomplete="off"
                                       value="{{ $item ? $item?->catch_cord_ends : old('catch_cord_ends') }}"/>
                            </td>
                            <td>Ends Per Wire</td>
                            <td>
                                <input type="number" step="0.01" name="ends_per_wire" id="ends_per_wire" class="form-control"
                                       autocomplete="off"
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.status) {
                                    ...
                                    $.each(data.item.warps, function (index, item) {
                                        let tr = '<tr>';
                                        tr += `<td><input type="checkbox" name="show_in_print" checked></td>`;
                                        tr += `<td>`;
