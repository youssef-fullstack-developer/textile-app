                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            ...
                            <select name="sizing_name_id" class="form-control" required>
                                <option value="">Select</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            ...
                            <input type="number" name="sizing_amount" class="form-control" autocomplete="off"
                    ...
                    <div class="form-group row">
                        <div class="col-4">
                            ...
                            <input type="number" name="ref_number" class="form-control" autocomplete="off"
                        ...
                        <div class="col-4">
                            ...
                            <select name="vendor_id" class="form-control" required>
                                ...
                                @foreach($vendors as $one)
                                    <option
                                        value="{{$one->id}}" {{$item?->vendor_id == $one->id ? 'selected' : '' }}>{{$one->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 border border-2 border-light-dark p-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                <label>Count</label>
                                <input type="text" id="count" class="form-control" disabled/>
                            </div>
                        </div>
                        {{-- Sub-line 2 --}}
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" name="cone_per_bag" class="form-control" autocomplete="off"
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" name="kg_per_bag" class="form-control" autocomplete="off"
                        ...
                        <div class="form-group row">
                            <div class="col-4">
                                ...
                                <input type="number" name="weight_per_cone" class="form-control" autocomplete="off"
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" name="bottom_percent" class="form-control" autocomplete="off"
                                       required
                                       value="{{$item ? $item?->bottom_percent : old('bottom_percent') }}"/>
                            </div>
                            <div class="col-4">
                                <label>Total Meter<b class="text-danger">*</b></label>
                                <input type="number" name="total_meter" class="form-control" autocomplete="off"
                        ...
                        <div class="form-group row">
                            <div class="col-4">
                                ...
                                <input type="number" name="c" class="form-control" autocomplete="off"
                                       required
                                       value="{{$item ? $item?->expexcted_meter : old('expexcted_meter') }}"/>
                            </div>
                            <div class="col-4">
                                <label>Meter Per Part<b class="text-danger">*</b></label>
                                <input type="number" name="meter_per_part" class="form-control" autocomplete="off"
                                       required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" name="given_meters" id="given_meters" class="form-control"
                                ...
                                <table class="table-hover table table-bordered">
                                    ...
                                    @foreach($item?->yarn_details ?? array() as $index => $row)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="yarn_details[{{$index}}][sort_ends]"
                                            ...
                                            <td>
                                                <input type="number" name="yarn_details[{{$index}}][meters]" required
                                                       id="meters_{{$index}}" onchange="change_totals({{$index}})"
                                                       class="form-control meters"
                                                       value="{{$row ? $row?->meters : ''}}"/>
                                            </td>
                                            <td>
                                                <input type="number" name="yarn_details[{{$index}}][warp_meters]"
                        ...
                        <table class="table-hover table table-bordered">
                            ...
                            @foreach($item?->beam_details ?? array() as $index => $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="beam_details[{{$index}}][beam_meters]"
                                               class="form-control"
                                               autocomplete="off"
                                               value="{{$row ? $row?->beam_meters : ''}}"/>
                                    </td>
                                    <td>
                                        <input type="number" name="beam_details[{{$index}}][expected_fabric_mtrs]"
                                               class="form-control" autocomplete="off"
                                               value="{{$row ? $row?->expected_fabric_mtrs : ''}}"/>
                                    </td>
                                    <td>
                                        <input type="number" name="beam_details[{{$index}}][warp_meters]"
                                               class="form-control"
                                               value="{{$row ? $row?->warp_meters : ''}}"/>
                                    </td>
                                    <td>
                                        <input type="number" name="beam_details[{{$index}}][beam_dia]"
                                               class="form-control"
                                               autocomplete="off"
        ...
        @push('scripts')
            <script>
                ...
                const add_yarn_detail = () => {
                    ...
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="yarn_details[${index}][sort_ends]"`;
                    html += `               id="sort_ends_${index}" onchange="change_sizing_ends(${index})"`;
                    html += `               class="form-control" autocomplete="off" required/>`;
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="yarn_details[${index}][sizing_ends]"`;
                    html += `               id="sizing_ends_${index}"`;
                    html += `               class="form-control" autocomplete="off" required/>`;
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="yarn_details[${index}][width]"`;
                    html += `               id="width_${index}" onchange="change_sizing_ends(${index})"`;
                    html += `               class="form-control" autocomplete="off" required/>`;
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="yarn_details[${index}][parts]"`;
                    html += `               id="parts_${index}" onchange="change_ends_per_parts(${index})"`;
                    html += `               class="form-control" autocomplete="off" required/>`;
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="yarn_details[${index}][ends_per_parts]"`;
                    html += `               id="ends_per_parts_${index}" `;
                    html += `               class="form-control" autocomplete="off" required/>`;
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="yarn_details[${index}][dbf]"`;
                    ...
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="yarn_details[${index}][meters]"`;
                    html += `                id="meters_${index}" onchange="change_totals(${index})"`;
                    html += `               class="form-control meters" autocomplete="off" required/>`;
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="yarn_details[${index}][warp_meters]"`;
                ...
                const add_beam_details = () => {
                    ...
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="beam_details[${index}][beam_meters]"`;
                    html += `               class="form-control" autocomplete="off"/>`;
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="beam_details[${index}][expected_fabric_mtrs]"`;
                    html += `               class="form-control" autocomplete="off"/>`;
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="beam_details[${index}][warp_meters]"`;
                    html += `               class="form-control"/>`;
                    html += `    </td>`;
                    html += `    <td>`;
                    html += `        <input type="number" name="beam_details[${index}][beam_dia]"`;
                    html += `               class="form-control"/>`;
                    html += `    </td>`;
                    html += `    <td>`;
