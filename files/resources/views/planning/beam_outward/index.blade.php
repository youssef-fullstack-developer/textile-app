...
@section('content')
    @php
        $route_main = 'beam_outward';
        $module_label = 'BEAM OUTWARD';
        $permission_name = 'beam_outward';
    @endphp
    <div class="card card-custom" style="box-shadow: none">
        <div class="card-header flex-wrap border-0 pt-0 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('beam_outward.create') }}" class="btn btn-primary font-weight-bolder mr-2">
                    ...
                    @foreach ($list as $key => $item)
                        <tr>
                            ...
                            @php
                                ...
                                $meters = 0;
                                    foreach ($item?->details as $index => $row){
                                        $orders .= $row->order?->order_no.', ';
                                        $contracts .= $row->weaver?->name.', ';
                                        $qualities .= $row->yarn?->name.', ';
                            ...
                            <td class="d-flex">
                                ...
                                <a href="{{ route('beam_outward.edit', $item->id) }}"
