                        ...
                        <div class="col-4">
                            ...
                            <select name="invoice_type_id" class="form-control">
                                ...
                                @foreach($invoice_types as $row)
                                    <option
                                        value="{{$row->id}}" {{ ($item?->invoice_type_id == $row->id) ? 'selected' : '' }}>{{$row->value}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <select name="city_id" class="form-control">
                                ...
                                @foreach($cities as $row)
                                    <option
                                        value="{{$row->id}}" {{ ($item?->city_id == $row->id) ? 'selected' : '' }}>{{$row->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-4">
                            ...
                            <select name="sourcing_executive_id" class="form-control">
                                <option value="">Select</option>
                                @foreach($sourcing_executives as $row)
                                    <option
                                        value="{{$row->id}}" {{ ($item?->sourcing_executive_id == $row->id) ? 'selected' : '' }}>{{$row->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            ...
                            <input type="text" name="port_destination" class="form-control"
                                   ...
                                   value="{{$item ? $item?->port_destination : old('port_destination') }}"/>
                        </div>
                    </div>
                        ...
                        @while( (empty($item) &&  $i == 0) || (count($item?->sales_order_details ?? []) > $i ) )
                            ...
                            <div class="form-group border p-3 border-dark border-2 tr">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-4" id="finished_quality_{{$i}}" style="display: none">
                                        ...
                                        >
                                            ...
                                            @foreach($sorts as $row)
                                                <option
                                                    value="{{$row->id}}" {{ ($detail?->finished_quality_id == $row->id) ? 'selected' : '' }}>{{$row->sort_no}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-4">
                                ...
                                <div class="form-group row">
                                    <div class="col-4">
                                        ...
                                        <select name="order_details[{{$i}}][first_quality_id]" class="form-control"
                                            ...
                                            @foreach($sorts as $row)
                                                <option
                                                    value="{{$row->id}}" {{ ($detail?->first_quality_id == $row->id) ? 'selected' : '' }}>{{$row->sort_no}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-4">
...
@push('scripts')
    <script>
        ...
        const add_order_details = () => {
            ...
            html += `                        >`;
            html += `                    <option value="">Select</option>`;
            html += `                    @foreach($sorts as $row)`;
            html += `                    <option`;
            html += `                        value="{{$row->id}}" >{{$row->sort_no}}</option>`;
            html += `                    @endforeach`;
            html += `                </select>`;
            html += `            </div>`;
            html += `            <div class="col-4">`;
            ...
            html += `                    <option value="">Select</option>`;
            html += `                    @foreach($weave_types as $row)`;
            html += `                    <option`;
            html += `                        value="{{$row->id}}" >{{$row->name}}</option>`;
            html += `                    @endforeach`;
            html += `                </select>`;
