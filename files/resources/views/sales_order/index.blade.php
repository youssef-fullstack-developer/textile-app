                ...
                @if (!empty($list))
                    @foreach ($list as $key => $row)
                        <tr>
                            ...
                            <td>@foreach($row->sales_order_details as $detail)
                                    {{$detail?->quality?->sort_no}},
                                @endforeach</td>
                            <td>@foreach($row->sales_order_details as $detail)
                                    {{$detail?->quality?->sort_no}},
                                @endforeach</td>
                            ...
                            @php
                                $balance_quantity = 0;
                                foreach ($row->sales_order_details as $detail){
                                        $balance_quantity += $detail?->quantity;
                                }
                            @endphp
                            ...
                            <td class="d-flex">
                                ...
                                <a href="{{ route('sales_order.edit', $row->id) }}"
