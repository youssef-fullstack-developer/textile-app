...
class SalesOrderDetail extends Model
{
    ...
    {
        return $this->belongsTo(SalesOrder::class, 'sales_order_id', 'id')->with('buyer','contract_type','ship_to','user','sourcing_executive','bank','so_type','payment_terms','city', 'terms_conditions');
    }

    public function yarn_certification_types()
    {
        return $this->hasMany(SalesOrderYarnCertification::class, 'sales_order_detail_id', 'id');
    }
