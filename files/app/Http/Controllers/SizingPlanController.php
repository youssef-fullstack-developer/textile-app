...
class SizingPlanController extends Controller
{
    ...
    public function create()
    {
        ...
        $weave_types = Weave::all();
        return view('planning.sizing_plan.add', compact('loom_types', 'weave_types', 'sorts', 'vendors', 'payment_terms', 'machines', 'employes', 'yarns', 'coparts', 'weavers', 'orders', 'loom_models', 'looms'));
    }
    ...
    public function edit($id)
    {
        ...
        $sorts = Sort::where('status', 1)->get();
        $weave_types = Weave::all();
        $item = SizingPlan::where('id',$id)->with('beam_details', 'yarn_details')->first();
        return view('planning.sizing_plan.add', compact('item', 'loom_types', 'weave_types', 'sorts', 'vendors', 'payment_terms', 'machines', 'employes', 'yarns', 'coparts', 'weavers', 'orders', 'loom_models', 'looms'));
