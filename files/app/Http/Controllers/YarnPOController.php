...
class YarnPOController extends Controller
{
    ...
    public function list($type = null)
    {
        ...
        $list = YarnPO::where('approval', $type)->with('details')->get();
    ...
    public function create()
    {
        ...
        return view('purchase.yarn_po.add', compact('csp', 'hairiness', 'count_cvs','vendor_groups', 'strenght_cvs', 'vendors', 'agents', 'certification_types', 'po_types', 'sale_orders', 'payment_terms', 'vendors', 'terms_consitions', 'consignees', 'yarn_types', 'delivery_terms', 'purchase_types', 'counts', 'vendors', 'igst', 'cgst', 'sgst'));
    ...
    public function show(Request $request, $id)
    {
        ...
        if($get_details && !empty($get_details)) {
            ...
            $item = YarnPO::where('id', $id)->with('details', 'vendor_group', 'agent', 'certification_type', 'po_type', 'pr_num', 'so_num', 'payment_terms', 'vendor', 'terms_conditions', 'consignee', 'yarn_type')->first();
        }
        $status = true;
        if (!$item) {
            $status = false;
    ...
    public function edit($id)
    {
        ...
        return view('purchase.yarn_po.add', compact('item', 'csp','vendor_groups', 'hairiness', 'count_cvs', 'strenght_cvs','vendors', 'agents', 'certification_types', 'po_types', 'sale_orders', 'payment_terms', 'vendors', 'terms_consitions', 'consignees', 'yarn_types', 'delivery_terms', 'purchase_types', 'counts', 'vendors', 'igst', 'cgst', 'sgst'));
...
//  Approval Po Yarn Functions
    ...
    public function approval_list($type = null)
    {
        ...
        $list = YarnPO::where('approval', $type)->with('details')->get();
        return view('approvals.po_yarn.index', compact('type', 'list'));
    }
    ...
    public function approval_get($id = null)
    {
        ...
        return view('approvals.po_yarn.add', compact('item', 'currentDateTime'));
    }
