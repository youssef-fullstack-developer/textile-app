...
//            $det["weaving_qty"] = $order_details["weaving_qty"];
//            $det["purchase_qty"] = $order_details["purchase_qty"];
...
//            $det["currency"] = $order_details["currency"];
    ...
    public function edit($id)
    {
        ...
        return view('sales_order.add', compact('item', 'invoice_types','vendors', 'contract_types', 'cities', 'buyers', 'sourcing_executives', 'countries', 'agents', 'shipping_terms', 'banks', 'container_sizes', 'payment_terms', 'terms_conditions', 'users', 'sales_co_ordinators', 'so_types', 'sorts', 'weave_types', 'sorts', 'selvedges', 'units', 'inspection_types', 'paper_tube_sizes', 'yarn_certification_types'));
    }
...
//            $det["currency"] = $order_details["currency"];
    ...
    {
        $data = SalesOrder::with('buyer')->get();
        return response()->json(['status' => true, 'data' => $data]);
    }
    public function get_sales_orders_details()
    {
        $data = SalesOrderDetail::with('sales_order', 'finished_quality','yarn_certification_types', 'sales_order_sub_details', 'quality', 'inspection_type', 'paper_tube_size', 'selvedge', 'weave_type', 'unit' )->get();
